      ...
      <div className="mx-auto flex-col pt-[223px] text-center">
        <Link href="/">
          <div className="mx-auto my-0 inline-block justify-center">
            <Image
              src={"/taskify-logo-with-letter.png"}
              alt="taskify"
              width={200}
              height={279}
            />
        ...
        <h1 className="mt-[10px] text-lg text-[20px]">
          오늘도 만나서 반가워요!
        </h1>
      </div>
      <Form {...form}>
        <form
          ...
          className="flex w-[520px] h-[50px] flex-col gap-6 rounded-lg bg-white px-7 py-8 font-bold text-gray-700 mx-auto"
        >
          ...
          <div className="flex">
            <Button
              type="submit"
              className="h-[50px] w-[520px] bg-violet-100 hover:bg-violet-100/80 text-[18px]"
            >
              로그인
            </Button>
          </div>
